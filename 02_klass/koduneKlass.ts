class Car {
    ...
    calculateFuelCost(distance: number, fuelPrice: number) {
        ...
        console.log(this.brand + ' ' + this.model + ' küttekulu hind, vahemikus: ' + distance + ' km on ' + fuelCost.toFixed(2) + ' €');
    }
}
...
//Väljund 1: Toyota Corolla küttekulu hind, vahemikus: 300 km on 29.25 €

//Teine auto
let car2 = new Car("Ford", "Mustang", 12);
car2.calculateFuelCost(300, 1.7); 
//Väljund 2: Ford Mustang küttekulu hind, vahemikus: 300 km on 61.20 €
